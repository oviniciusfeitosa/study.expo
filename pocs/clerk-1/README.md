...
- `git clone --depth 1 -b router-v2 https://github.com/clerk/clerk-expo-starter.git clerk-login && rm -rf ./clerk-login/.git`
- Remove `expo-dev-client` dependency from `package.json`
- `cp .env.example .env`
  - Set your key
- Get expo project id: <https://expo.dev/accounts>
- Change `eas` inside `app.json` to `864c0068-c8f1-4221-802f-50973900eff6`
